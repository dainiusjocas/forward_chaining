...
public class Implication {
    private String id; /* format: "Rn:" where n is the number of imlication */
    private String antecedent; /* format "A, B, C" */
    private String consequent; /* format "A" */
     ...
     * @return
     */
    /* TODO this method should be able o work with consequents that are list of
     * goals.
     */
